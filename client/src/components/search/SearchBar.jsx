...
const SearchBar = () => {
    ...
    const renderSearchResult = (attrs) => (
        <div
            tabIndex="-1"
            {...attrs}
            className="w-full min-[425px]:w-[425px] sm:w-[370px] md:w-[460px] lg:w-[460px] xl:w-[526px] border-t-0 border border-gray-200 md:border-2 md:border-main shadow-md rounded-b-lg bg-white relative -top-[10px]"
        >
